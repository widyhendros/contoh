<x-app-layout>
    ...
    <section class="section">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link {{ $page == 2 ? 'active' : '' }}" id="pills-tempattinggal-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-tempattinggal" type="button" role="tab" aria-controls="pills-tempattinggal"
                    aria-selected="false"><span class="bi bi-house-door">
                    </span><span class="title">Data Tempat Tingal</span></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link {{ $page == 3 ? 'active' : '' }}" id="pills-tandabadan-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-tandabadan" type="button" role="tab" aria-controls="pills-tandabadan"
                    aria-selected="false"><span class="bi bi-heart-pulse">
                    </span><span class="title">Data Tanda Badan</span></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link {{ $page == 4 ? 'active' : '' }}" id="pills-pendidikan-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-pendidikan" type="button" role="tab" aria-controls="pills-pendidikan"
                    aria-selected="false"><span class="bi bi-book">
                    </span><span class="title">Data Pendidikan</span></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link {{ $page == 5 ? 'active' : '' }}" id="pills-orangtuawali-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-orangtuawali" type="button" role="tab" aria-controls="pills-orangtuawali"
                    aria-selected="false"><span class="bi bi-people">
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade {{ $page == 1 ? 'show active' : '' }}" id="pills-datasiswa" role="tabpanel"
                ...
                <form enctype="multipart/form-data" action="{{route('admininsertpribadisiswa')}}" method="post">
                    @csrf
                    <input type="text" class="form-control" id="siswaid" name="siswaid"
                        value="@if(isset($siswa->id)) {{$siswa->id}} @endif" readonly hidden>
                    <div class="card">
                        ...
                        <div class="card-body px-12 border border-success">
                            <div class="row mt-2">
                                <div class="mb-2 row mt-4">
                                    <label for="nis" class="col-sm-3 col-form-label">Tahun Masuk</label>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control text-center"  name="thn_masuk"
                                            value="@if(isset($siswa->thn_masuk)) {{$siswa->thn_masuk}} @endif">
                                        {{-- <input type="text" class="form-control input-group-text" id="nis" readonly> --}}
                                    </div>
                                </div>
                                ...
                                <div class="mb-2 row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" class="form-control text-center" id="nis" name="nis"
                                            value="@if(isset($siswa->nis)) {{$siswa->nis}} @endif">
                                        {{-- <input type="text" class="form-control input-group-text" id="nis" readonly> --}}
                                    </div>
                                </div>
                                <div class="mb-0 row">
                                    ...
                                    <div class="col-md-3">
                                        <fieldset class="form-group">
                                            <select class="form-select text-center" id="jalurMasuk" name="jalurMasuk">
                                                <option value="">[ PILIH ]</option>
                                ...
                                <div class="mb-0 row">
                                    ...
                                    <div class="col-md-2">
                                        <fieldset class="form-group">
                                            <select class="form-select text-center" id="jurusan" name="nmjurusan">
                                                <option value="">[ PILIH ]</option>
                                ...
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" id="namaLengkap" name="namaLengkap"
                                            value="@if(isset($siswa->nmlengkap)) {{$siswa->nmlengkap}} @endif">
                                    </div>
                                </div>
                                <div class="mb-0 row mt-3">
                                ...
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" class="form-control text-center" id="nisn" name="nisn"
                                            value="@if(isset($siswa->nisn)) {{$siswa->nisn}} @endif" >
                                        <input type="text" name="hiden_nisn" value="{{ $siswa->nisn }}" hidden>
                                ...
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="form-control text-center" id="nik" name="nik"
                                            value="@if(isset($siswa->nik)) {{$siswa->nik}} @endif">
                                    </div>
                                </div>
                                <div class="mb-0 row mt-3">
                                ...
                                <div class="mb-0 row">
                                    ...
                                    <div class="col-md-2">
                                        <fieldset class="form-group">
                                            <select class="form-select" id="basicSelect" name="statusanak">
                                                <option value="">[ PILIH ]</option>
                                ...
                                {{-- <p><small class="text-muted">Tulis dengan Angka (Misal : 1)</small></p> --}}
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input type="number" class="form-control" id="tiri" name="jmlsaudaratiri"
                                            value="{{$siswa->jmlsaudaratiri==null ?0:$siswa->jmlsaudaratiri;}}">
                                    </div>
                                </div>
                                <div class="mb-0 row mt-3">
                                ...
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="tmplahir" name="tmplahir"
                                            value=@if(isset($siswa->tmplahir)) {{$siswa->tmplahir}} @endif>
                                    </div>
                                </div>
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <input type="date" class="form-control" id="tanggallahir" name="tanggallahir"
                                            value=@if(isset($siswa->tanggallahir)) {{$siswa->tanggallahir}} @endif>
                                    </div>
                                </div>
                                <div class="mb-0 row mt-3">
                                ...
                                <div class="mb-5 row mt-3">
                                    ...
                                    <div class="col-md-5">
                                        <input type="email" class="form-control" id="email" name="email"
                                            value=@if(isset($siswa->email)) {{$siswa->email}} @endif>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="tab-pane fade {{ $page == 2 ? 'show active' : '' }}" id="pills-tempattinggal" role="tabpanel"
                ...
                <form enctype="multipart/form-data" action="{{route('admininserttempattinggal')}}" method="post">
                    @csrf
                    <input type="text" class="form-control" id="siswaid" name="siswaid"
                        value="@if(isset($siswa->id)) {{$siswa->id}} @endif" readonly hidden>
                    <div class="card">
                        ...
                        <div class="card-body px-12 border border-success">
                            <div class="row mt-4">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div>
                                            <input type="text" class="col-sm-12 form-control" id="jalan" name="jalan"
                                                value="@if(isset($alamat->jalan)) {{$alamat->jalan}} @endif">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div>
                                                ...
                                                <div>
                                                    <input type="text" class="form-control" id="rt" name="rt"
                                                        value="@if(isset($alamat->rt)) {{$alamat->rt}} @endif">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div>
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control" id="rw" name="rw"
                                                        value="@if(isset($alamat->rw)) {{$alamat->rw}} @endif">
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <label for="nis" class="col-form-label">Kota</label>
                                        </div>
                                        <div>
                                            <input type="text" class="col-sm-12 form-control" id="kota" name="kota"
                                                value="@if(isset($alamat->kota)) {{$alamat->kota}} @endif">
                                        </div>
                                        <div>
                                            <label for="nis" class="col-form-label">Kode POS</label>
                                        </div>
                                        <div>
                                            <input type="text" class="col-sm-12 form-control" id="kodepos"
                                                name="kodepos" maxlength="5"
                                                value="@if(isset($alamat->kodepos)) {{$alamat->kodepos}} @endif">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div>
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="@if(isset($alamat->jarak)) {{$alamat->jarak}} @endif">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="@if(isset($alamat->wkttempuh)) {{$alamat->wkttempuh}} @endif">
                                ...
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="telprumah" name="telprumah"
                                            value="@if(isset($alamat->telprumah)) {{$alamat->telprumah}} @endif">
                                    </div>
                                </div>
                                <div class="mb-5 row mt-3">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="nohp" name="nohp"
                                            value="@if(isset($alamat->nohp)) {{$alamat->nohp}} @endif">
                                    </div>
                                </div>
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            ...
            <!-- DATA TANDA BADAN  -->
            <div class="tab-pane fade {{ $page == 3 ? 'show active' : '' }}" id="pills-tandabadan" role="tabpanel" aria-labelledby="pills-tandabadan-tab">
                <form enctype="multipart/form-data" action="{{route('admininserttandabadan')}}" method="post">
                    @csrf
                    <input type="text" class="form-control" id="siswaid" name="siswaid"
                        value="@if(isset($siswa->id)) {{$siswa->id}} @endif" readonly hidden>
                    <div class="card">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control"
                                                        aria-describedby="basic-addon2" name="berat"
                                                        value="@if(isset($tandabadan->berat)) {{$tandabadan->berat}} @endif">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control"
                                                        aria-describedby="basic-addon2" name="tinggi"
                                                        value="@if(isset($tandabadan->tinggi)) {{$tandabadan->tinggi}} @endif">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control"
                                                        aria-describedby="basic-addon2" name="lingkep"
                                                        value="@if(isset($tandabadan->lingkep)) {{$tandabadan->lingkep}} @endif" required>
                                                    <span class="input-group-text" id="basic-addon2">Cm</span>
                                                </div>
                                            </div>
                                        </div>
            ...
            <!-- DATA PENDIDIKAN  -->
            <div class="tab-pane fade {{ $page == 4 ? 'show active' : '' }}" id="pills-pendidikan" role="tabpanel" aria-labelledby="pills-pendidikan-tab">
                <form enctype="multipart/form-data" action="{{route('admininsertdatapendidikan')}}" method="post">
                    @csrf
                    <input type="text" class="form-control" id="siswaid" name="siswaid"
                        value="@if(isset($siswa->id)) {{$siswa->id}} @endif" readonly hidden>
                    <div class="card">
                        ...
                        <div class="card-body px-12 border border-success">
                            <div class="row mt-4">
                                <div class="card border border-warning border-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            ...
                                            <li>Jika data belum ada isi - atau 0</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control text-center" id="smpmts"
                                            name="namasmp"
                                ...
                                <div class="mb-0 row mt-3">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="date" class="form-control text-center" id="smpmts"
                                            name="tglijazah" value=@if(isset($datapendidikan->tglijazah))
            ...
            <!-- DATA ORANG TUA / WALI  -->
            <div class="tab-pane fade {{ $page == 5 ? 'show active' : '' }}" id="pills-orangtuawali" role="tabpanel" aria-labelledby="pills-orangtuawali-tab">
                <form enctype="multipart/form-data" action="{{route('admininsertorangtuawali')}}" method="post">
                    @csrf
                    <input type="text" class="form-control" id="siswaid" name="siswaid"
                        value="@if(isset($siswa->id)) {{$siswa->id}} @endif" readonly hidden>
                    <div class="card">
                            ...
                            <div class="row mt-4">
                                ...
                                <div id="div_orangtua" style="display: none">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="col-md-12 row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" id="rtbpk" name="rtbpk"
                                                            value="@if(isset($orangtuawali->rtbpk)) {{$orangtuawali->rtbpk}} @endif"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" id="rwbpk" name="rwbpk"
                                                            value="@if(isset($orangtuawali->rwbpk)) {{$orangtuawali->rwbpk}} @endif"
                                                            maxlength="2" 
                                                            onkeypress="validateOnlyNumber(event)"
                                                            required>
                                                    </div>
                                            ...
                                            <div class="col-md-12 row">
                                                ...
                                                <div>
                                                    <input type="text" class="form-control" id="posbpk"
                                                        name="kodeposbpk"
                                                        value="@if(isset($orangtuawali->kodeposbpk)) {{$orangtuawali->kodeposbpk}} @endif" maxlength="5"                                                             onkeypress="validateOnlyNumber(event)"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-0 row mt-3">
                                        <label for="telprumah" class="col-sm-3 col-form-label">Telepon Rumah</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="telprumahbpk"
                                                name="telprumahbpk"
                                                value="@if(isset($orangtuawali->telprumahbpk)) {{$orangtuawali->telprumahbpk}} @endif"
                                                onkeypress="validateOnlyNumber(event)"
                                                maxlength="10" >
                                        </div>
                                    </div>
                                    <div class="mb-5 row mt-3">
                                        <label for="nohp" class="col-sm-3 col-form-label">Nomor HP</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="nohpbpk" name="nohpbpk" maxlength="13"
                                                value="@if(isset($orangtuawali->nohpbpk)) {{$orangtuawali->nohpbpk}} @endif"
                                                onkeypress="validateOnlyNumber(event)" maxlength="13"
                                                 required>
                                        </div>
                                    </div>
                                    <div class="mb-0 row">
                                        ...
                                        <div class="col-sm-4">
                                            <fieldset class="form-group">
                                                <select class="form-select text-center" id="penghasilanbapak"
                                                    ...
                                                    <option value="">[ PILIH ]</option>
                                                    <option value="Tidak Berpenghasilan" @if(isset($orangtuawali->
                                                        penghasilanbpk))
                                                        @if($orangtuawali->penghasilanbpk == 'Tidak Berpenghasilan')
                                                        selected="selected" @endif @endif>Tidak Berpenghasilan</option>
                                                    <option value="Kurang dari Rp. 500.000" @if(isset($orangtuawali->
                                                        penghasilanbpk))
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="col-md-12 row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" id="rtibu" name="rtibu"
                                                            value="@if(isset($orangtuawali->rtibu)) {{$orangtuawali->rtibu}} @endif"
                                                            onkeypress="validateOnlyNumber(event)"
                                                            maxlength="2" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" id="rwibu" name="rwibu"
                                                            value="@if(isset($orangtuawali->rwibu)) {{$orangtuawali->rwibu}} @endif"
                                                            onkeypress="validateOnlyNumber(event)"
                                                            maxlength="2" 
                                                            required>
                                                    </div>
                                            ...
                                            <div class="col-md-12 row">
                                                ...
                                                <div>
                                                    <input type="text" class="form-control" id="posibu"
                                                        name="kodeposibu"
                                                        value="@if(isset($orangtuawali->kodeposibu)) {{$orangtuawali->kodeposibu}} @endif"
                                                            onkeypress="validateOnlyNumber(event)"
                                                            maxlength="5" 
                                                        required>
                                                </div>
                                    ...
                                    <div class="mb-0 row mt-3">
                                        <label for="telprumah" class="col-sm-3 col-form-label">Telepon Rumah</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="telprumahibu"
                                                name="telprumahibu"
                                                value="@if(isset($orangtuawali->telprumahibu)) {{$orangtuawali->telprumahibu}} @endif"
                                                onkeypress="validateOnlyNumber(event)"
                                                maxlength="10" 
                                               >
                                        </div>
                                    ...
                                    <div class="mb-5 row mt-3">
                                        <label for="nohp" class="col-sm-3 col-form-label">Nomor HP</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="nohpibu" name="nohpibu"
                                                value="@if(isset($orangtuawali->nohpibu)) {{$orangtuawali->nohpibu}} @endif"
                                                onkeypress="validateOnlyNumber(event)"
                                                maxlength="13" 
                                                required>
                                        </div>
                                ...
                                <div id="div_wali" style="display: none">
                                        ...
                                        <div class="col-sm-3">
                                            <fieldset class="form-group">
                                                <select class="form-select text-center" id="basicSelect"
                                                    ...
                                                    <option value="nenek" @if(isset($orangtuawali->
                                                        hubungandgnsiswawali)) @if($orangtuawali->hubungandgnsiswawali
                                                        == 'nenek') selected="selected" @endif @endif>Nenek</option>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="col-md-12 row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" id="rtwali"
                                                            name="rtwali"
                                                            value="@if(isset($orangtuawali->rtwali)) {{$orangtuawali->rtwali}} @endif"
                                                            onkeypress="validateOnlyNumber(event)"
                                                            maxlength="2">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" id="rwwali"
                                                            name="rwwali"
                                                            value="@if(isset($orangtuawali->rwwali)) {{$orangtuawali->rwwali}} @endif"
                                                            onkeypress="validateOnlyNumber(event)"
                                                            maxlength="2">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12 row">
                                                ...
                                                <div>
                                                    <input type="text" class="col-sm-12 form-control" id="poswali"
                                                        name="kodeposwali"
                                                        value="@if(isset($orangtuawali->kodeposwali)) {{$orangtuawali->kodeposwali}} @endif"
                                                        onkeypress="validateOnlyNumber(event)"
                                                        maxlength="5">
                                                </div>
                                            </div>
                                    ...
                                    <div class="mb-0 row mt-3">
                                        <label for="telprumah" class="col-sm-3 col-form-label">Telepon Rumah</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="telprumahwali"
                                                name="telprumahwali"
                                                value="@if(isset($orangtuawali->telprumahwali)) {{$orangtuawali->telprumahwali}} @endif"
                                                onkeypress="validateOnlyNumber(event)"
                                                maxlength="10">
                                        </div>
                                    </div>
                                    <div class="mb-5 row mt-3">
                                        <label for="nohp" class="col-sm-3 col-form-label">Nomor HP</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="nohp" name="nohpwali"
                                                value="@if(isset($orangtuawali->nohpwali)) {{$orangtuawali->nohpwali}} @endif"
                                                onkeypress="validateOnlyNumber(event)"
                                                maxlength="13">
                                        </div>
                                    </div>
                                            ...
                                            <fieldset class="form-group">
                                                <select class="form-select text-center" id="basicSelect"
                                                    ...
                                                    <option value="karyawan swasta" @if(isset($orangtuawali->
                                                        ...
                                                        selected="selected"
                                                        @endif @endif>Karyawan Swasta</option>
                                                    <option value="pedagang kecil" @if(isset($orangtuawali->
                                                        profesiwali))
                                                        @if($orangtuawali->profesiwali == 'pedagang kecil')
                                                        selected="selected"
                                                        @endif @endif>Pedagang Kecil</option>
                                                    <option value="pedagang besar" @if(isset($orangtuawali->
                                                        profesiwali))
                                            ...
                                            <fieldset class="form-group">
                                                <select class="form-select text-center" id="basicSelect"
                                                    ...
                                                    <option value="Tidak Berpenghasilan" @if(isset($orangtuawali->penghasilanwali))
                                                        ...
                                                        selected="selected" @endif @endif>Tidak Berpenghasilan</option>
                                                    <option value="Kurang dari Rp. 500.000" @if(isset($orangtuawali->
                                                        penghasilanwali)) @if($orangtuawali->penghasilanwali == 'Kurang dari Rp. 500.000') selected="selected" @endif @endif>Kurang dari
                                                        Rp. 500.000</option>
            ...
            <!-- DATA HOBI DAN MINAT  -->
            <div class="tab-pane fade {{ $page == 6 ? 'show active' : '' }}" id="pills-hobiminat" role="tabpanel" aria-labelledby="pills-hobiminat-tab">
                <form enctype="multipart/form-data" action="{{route('admininserthobidanminat')}}" method="post">
                    @csrf
                    <input type="text" class="form-control" id="siswaid" name="siswaid"
                        value="@if(isset($siswa->id)) {{$siswa->id}} @endif" readonly hidden>
                    <div class="card">
                        ...
                        <div class="card-body px-12 border border-success">
                            <div class="row mt-4">
                                <div class="mb-2 row mt-3">
                                    <div class="mb-2 row mt-3">
                                        <div class="col-sm-3">
                                            <label for="nis" class="col-form-label">Hobi</label>
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="mb-2 row mt-3">
                                        <div class="col-sm-3">
                                            <label for="nis" class="col-form-label">Cita - cita</label>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="col-md-12 row mb-2">
                                                <div class="form-check">
                                    ...
                                    <div class="mb-2 row mt-3">
                                        <div class="col-sm-3">
                                            <label for="nis" class="col-form-label">Minat Ekskul</label>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="col-md-12 row mb-2">
                                                <div class="form-check">
            ...
            <div class="tab-pane fade {{ $page == 7 ? 'show active' : '' }}" id="pills-peminatan" role="tabpanel" aria-labelledby="pills-peminatan-tab">
                <form enctype="multipart/form-data" action="{{route('admininsertpeminatan')}}" method="post">
                    @csrf
                    <input type="text" class="form-control" id="siswaid" name="siswaid"
                        value="@if(isset($siswa->id)) {{$siswa->id}} @endif" readonly hidden>
                    <div class="card">
                                ...
                                <div class="card border border-warning border-3">
                                    ...
                                    <div class="card-body">
                                        <ul>
                                            ...
                                            <li>Jika pada peminatan pilihan 1 ananda memilih <b
                                                    class="text-danger">"MIPA"</b>, maka pilihan lintas minatnya yang
                                                akan
                                        ...
                                        <ul>
                                            ...
                                            <li>Isi data nilai rapor dengan <b class="text-danger">nilai pengetahuan</b>
                                                dari <b class="text-danger">Semester 1</b> s/d <b
                                                    class="text-danger">Semester 5</b>
                                            </li>
                                        </ul>
                                        <small>Catatan :</small>
            ...
            <!-- DATA SCAN BERKAS  -->
            <div class="tab-pane fade {{ $page == 9 ? 'show active' : '' }}" id="pills-scanberkas" role="tabpanel" aria-labelledby="pills-scanberkas-tab">
                <form enctype="multipart/form-data" action="{{route('admininsertfileberkas')}}" method="post">
                    @csrf
                    <input type="text" class="form-control" id="siswaid" name="siswaid"
                        value="@if(isset($siswa->id)) {{$siswa->id}} @endif" readonly hidden>
                    <div class="card">
                        ...
                        <div class="card-body px-12 border border-success">
                            <div class="row mt-4">
                                ...
                                <div class="mb-3 row mt-3" id="berkaskks">
                                    <div class="d-md-flex">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Kartu Keluarga Sejahtera
                                        (
                                        KKS )</label>
                                    <div class="col-sm-5">
